...
class SignInSignUpWidget extends StatefulWidget {
  ...
  @override
  _SignInSignUpWidgetState createState() => _SignInSignUpWidgetState();
}
...
class _SignInSignUpWidgetState extends State<SignInSignUpWidget> {
  ...
  void initState() {
    super.initState();
    displayNameCreateController = TextEditingController();
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0, 12, 0, 0),
                                          child: Text(
                                            'Sau logheaza-te folosind alt cont',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyText1
                                                .override(
                                ...
                                children: [
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        20, 12, 20, 0),
                                    child: TextFormField(
                                      controller: displayNameCreateController,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'Numele Complet',
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .bodyText2
                                            .override(
                                              fontFamily: 'Outfit',
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0, 24, 0, 0),
                                          child: Text(
                                            'Inregistreaza-te folosind un cont social',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyText1
                                                .override(
                                                  fontFamily: 'Lexend Deca',
